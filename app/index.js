...
module.exports = generators.Base.extend({
    ...
    writing: {
        ...
        scaffoldFolders: function() {
            ...
            mkdirp(this.appname + "/Views/Some");
        ...
        controller: function() {
            ...
            this.fs.copyTpl(
                this.templatePath('_Controllers/_SomeController.cs'),
                this.destinationPath(this.appname + '/Controllers/SomeController.cs'), { namespace: this.appname }
            );
        },
        ...
        model: function() {
            this.fs.copyTpl(
                this.templatePath('_Models/_Context.cs'),
                this.destinationPath(this.appname + '/Models/Context.cs'), { namespace: this.appname }
            );
            this.fs.copyTpl(
                this.templatePath('_Models/_User.cs'),
                this.destinationPath(this.appname + '/Models/User.cs'), { namespace: this.appname }
            );
            this.fs.copyTpl(
                this.templatePath('_Models/_UserLogin.cs'),
                this.destinationPath(this.appname + '/Models/UserLogin.cs'), { namespace: this.appname }
            );
            this.fs.copyTpl(
                this.templatePath('_Models/_UserRegister.cs'),
                this.destinationPath(this.appname + '/Models/UserRegister.cs'), { namespace: this.appname }
            );
        },
        ...
        views: function() {
            ...
            this.fs.copyTpl(
                this.templatePath('_Views/_Home/_LoginPartial.cshtml'),
                this.destinationPath(this.appname + '/Views/Home/LoginPartial.cshtml'), { namespace: this.appname }
            );
            this.fs.copyTpl(
                this.templatePath('_Views/_Some/_Index.cshtml'),
                this.destinationPath(this.appname + '/Views/Some/Index.cshtml'), { namespace: this.appname }
            );
            this.fs.copyTpl(
                this.templatePath('_Views/_Shared/_Layout.cshtml'),
                this.destinationPath(this.appname + '/Views/Shared/_Layout.cshtml'), { title: this.appname, framework: this.framework, jquery: this.jquery, namespace: this.appname }
            );
            this.fs.copyTpl(
